        ...
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          {meetingType === 'PRESENTIAL' ? (
            ...
            <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl text-center space-y-5">
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 text-left text-xs space-y-2 max-w-md mx-auto overflow-hidden">
                <p className="text-slate-400 break-words">Tema: <strong className="text-white break-words">{topic}</strong></p>
                {farm && <p className="text-slate-400 break-words">Local: <strong className="text-white break-words">{farm}</strong></p>}
